...
class ISBNValidator {
    ...
    // Method 2: Validate and format the code
...
public class MainISBNValidator {
    ...
    public static void main(String[] args) {
        ...
        String normalized = ISBNValidator.normalizeCode(raw);

        String result = ISBNValidator.validateAndFormat(normalized);
